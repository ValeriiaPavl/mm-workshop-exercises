    ...
    <div className="w-full mx-30">
      ...
      <main>
        <div className="container flex mx-auto">
          <div className="container flex flex-wrap w-full lg:w-1/2 items-center ml-0 pl-0">
            <div>
              ...
              <div>
                ...
                <div className="flex flex-row gap-3">
                  <button className="bg-indigo-600 p-2 text-white rounded-md">
                    Download for Free
                  </button>
        ...
        <div className="container flex mx-auto">
          <div className="flex mr-30">
            ...
            <div className="container flex flex-col p-8 justify-center mx-auto">
              <Introduction
...
feature of your product. It can also contain an image or
        ...
        <div className="container flex lg:flex-nowrap flex-wrap">
          <div className="flex flex-row items-center mt-6 gap-6 justify-center">
            <div className="flex flex-col justify-center">
              <Introduction
                header="Offer more benefits here"
                text="You can use this same layout with a flip image to highlight your rest of the benefits of your product. It can also contain an image or Illustration as above section along with some bullet points."
              ></Introduction>

              <div className="flex flex-col mt-6 gap-6">
                <ListItemWithSvg
                  text="Nextly is designed as a mobile first responsive template."
                  header="Mobile Responsive Template"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                ...
                <ListItemWithSvg
                  text="This template is powered by latest technologies and tools."
                  header="Powered by Next.js & TailwindCSS"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                ...
                <ListItemWithSvg
                  ...
                  text="Nextly comes with a zero-config light & dark mode. "
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
